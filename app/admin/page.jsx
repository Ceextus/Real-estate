      ...
      <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
        <div>
          ...
          <p className="text-gray-500 mt-2 font-medium">
            Welcome back to the Andreams Homes administration portal.
          </p>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {statCards.map((stat, i) => (
              ...
              >
                ...
                <div
                  className={`absolute -right-6 -top-6 w-32 h-32 ${stat.color} opacity-[0.03] rounded-full blur-2xl group-hover:opacity-[0.08] transition-opacity duration-500`}
                />
                <div
                  className={`absolute top-0 right-0 w-24 h-24 ${stat.color} opacity-[0.02] rounded-bl-full -mr-8 -mt-8 transition-transform duration-500 group-hover:scale-125`}
                />

                <div className="relative z-10 flex justify-between items-start mb-6">
                  <div
                    className={`w-14 h-14 rounded-2xl text-white ${stat.color} flex items-center justify-center shadow-lg shadow-${stat.color.split("-")[1]}-500/30 group-hover:scale-110 transition-transform duration-300`}
                  >
              ...
              {recentActivity.length === 0 ? (
                <div className="py-12 flex flex-col items-center justify-center text-center">
                  ...
                  <p className="text-sm text-gray-400 mt-1">
                    New messages and inspections will appear here.
                  </p>
                </div>
              ) : (
                <div className="space-y-6 relative">
                  ...
                  {recentActivity.map((activity, index) => (
                    ...
                    >
                      {/* Timeline Icon */}
                      <div
                        className={`relative z-10 w-11 h-11 shrink-0 rounded-2xl flex items-center justify-center shadow-sm shrink-0 transition-transform duration-300 group-hover:scale-110 ${
                      ...
                      >
                        {activity.type === "message" ? (
                          <BsEnvelopePaperHeart className="text-lg" />
                        ) : (
            ...
            <div className="bg-white rounded-[2rem] p-7 sm:p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100/80 h-max sticky top-28">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-1 gap-4">
                <Link
                  ...
                  className="group p-5 rounded-2xl border border-gray-100 hover:border-primary/30 bg-white hover:bg-primary/5 transition-all duration-300 flex items-center gap-4 hover:shadow-md"
                >
                ...
                <Link
                  href="/admin/gallery"
                  className="group p-5 rounded-2xl border border-gray-100 hover:border-accent/30 bg-white hover:bg-accent/5 transition-all duration-300 flex items-center gap-4 hover:shadow-md"
                >
                ...
                <Link
                  href="/admin/team"
                  className="group p-5 rounded-2xl border border-gray-100 hover:border-gray-900/30 bg-white hover:bg-gray-50 transition-all duration-300 flex items-center gap-4 hover:shadow-md"
                >
                ...
                <Link
                  ...
                  className="group p-5 rounded-2xl border border-gray-100 hover:border-green-500/30 bg-white hover:bg-green-50/50 transition-all duration-300 flex items-center gap-4 hover:shadow-md"
                >
